...
public class DiamondBOOM_NEG_variant extends JavaPlugin 
implements Listener
{
private HashMap<Class<? extends Entity>, List<String>> EWs = new HashMap();

public void onEnable() { if (getConfig().options().header() == null) {
	getLogger().info("DiamondBOOM -NEG variant enabled! BOOM! Non-player entities can no longer modify blocks!");
...
public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
	 if(cmd.getName().equalsIgnoreCase("boom")){ // This is the command, change it as you wish. However, you will als have to change it in the plugin.yml!
